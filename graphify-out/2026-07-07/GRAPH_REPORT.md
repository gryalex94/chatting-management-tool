...
## Corpus Check
- 167 files · ~135,467 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1093 nodes · 1738 edges · 67 communities (61 shown, 6 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.5)
...
Cohesion: 0.20
Nodes (10): prioritiseTasks(), { runAgentDetailed }, shiftDays(), { supabaseAdmin }, { buildTasksForDate, capLiveQueue }, crypto, { prioritiseTasks }, { requireMinRole } (+2 more)

### Community 11 - "Creators Page UI"
Cohesion: 0.19
Nodes (18): buildTasksForDate(), capLiveQueue(), countOpen(), defaultCluster(), defaultPriority(), keepByTenure(), loadIgnoreSet(), _norm() (+10 more)
...
- **Why does `supabaseAdmin` connect `Report Parsers` to `Daily Check Engine`, `Custom Task Creation`, `Daily Check Page UI`, `Tasks Page UI`, `Server Dependencies`, `Creators Page UI`, `ESLint Config`, `Chatter Profile UI`, `App Shell & Routing`, `computeChatterMetrics.js`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `supabaseAdmin` connect `Auth Context & API Client` to `Metrics Computation`, `Theme & Topbar`, `Vite Config`, `Review Task Generation`, `shifts.js`?**
